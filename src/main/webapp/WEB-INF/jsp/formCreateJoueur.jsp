...
<div id="wrapper" class="wrapper">
    <div class="container">
        ...
        <form action="/createJoueur" method="post" class="form" id="signup" class="form-example">
            <div class="form-example">
            ...
            <div class="form-example">
                <input type="text" name="sexe" id="H" placeholder="Sexe : H/F" required>
            </div>
            <div class="form-example">
                <button type="submit" id="login-button" class="loginbutton" form="signup">S'inscrire</button>
            </div>
        </form>
    </div>
</div>
