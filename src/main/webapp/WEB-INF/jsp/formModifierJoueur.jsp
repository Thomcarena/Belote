...
<div id="wrapper" class="wrapper">
    <div class="container">
        ...
        <form action="/modifierCompte" method="post" class="form" id="signup" class="form-example">
            <div class="form-example">
            ...
            <div class="form-example">
                <label>Sexe :</label>
                <input type="text" name="sexe" id="H" value="<%=session.getAttribute("sexe")%>" required>
            </div>
            <div class="form-example">
                <button type="submit" id="login-button" class="loginbutton" form="signup">Confirmer</button>
            </div>
        </form>
    </div>
</div>
