...
<!--
    ...
    <div id="wrapper" class="wrapper">
        <div class="container">
            <h1>Bienvenue sur le jeu de la Belote en ligne !</h1>
            <div id="error" class="error"></div>
            <button id="login-button" class="loginbutton"><a href="/formCreateJoueur">Inscription</a></button>
            <button id="signup-button" class="loginbutton"><a href="/formConnexionJoueur">Se connecter</a></button>
        </div>
    </div>
